  ...
  return (
    <div name="home" className="w-full md:h-screen bg-zinc-200 flex flex-col justify-between">
      <div className="grid md:grid-cols-2 max-w-screen-2xl m-auto items-center">
        ...
        <div className="flex flex-col mx-4 my-2 py-6 md:min-w[760px] bottom-[-5%]  bg-zinc-200 borderborder-slate-300 rounded-xl text-center shadow-xl">
        ...
        <div className="flex flex-col flex-wrap mx-4 my-2 py-6 md:min-w[760px] bottom-[-5%] bg-zinc-200 borderborder-slate-300 rounded-xl text-center shadow-xl">
          <p>Financial Assets</p>
          <div>
            <p>Icon. Informações atualizadas dos principais mercados globais.</p>
            <p>Icon. Suporte para Criptoativos.</p>
        ...
        <div className="flex flex-col flex-wrap my-2 py-6 md:min-w[760px] bottom-[-5%] bg-blue-500 borderborder-slate-300 rounded-xl text-center shadow-xxl">
          <p>Financial Assets</p>
          <div>
            <p>Icon. Informações atualizadas dos principais mercados globais.</p>
            <p>Icon. Suporte para Criptoativos.</p>
